...
class GameEndPopup(Screen):
    def __init__(
        ...
        self.main_menu_button = SmallTextButton(
            x + 60, y + 127, 5, self.image_library, "OK", self.go_to_main_menu
        )
        self.add_element(self.main_menu_button)
        self.mouse.register_button_observer(self.main_menu_button)

        self.new_game_button = SmallTextButton(
            x + 130 + 160,
            y + 127,
            5,
            self.image_library,
    ...
    def start_new_game(self):
        post_event(
            ...
            screen_name=self.new_game_screen_name,
